...
module.exports = require('stampit')()
  ...
  .methods({
     ...
     * }
     */
    validatePollRestrictions: function( callback ){
      ...
      db.query( query, function( error, result ){
        ...
        error = Object.keys( result.why )
          .filter( function( name ){
            return result.why[ name ];
          })
          .filter( function( name ){
            return name in errors.validation;
          })
          .map( function( name ){
            return errors.validation[ name ]();
          })[0];
